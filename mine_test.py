...
s = serial.Serial('com2', 115200, timeout=2)  # 打开串口，配置串口
db = pymysql.connect("localhost", "root", "270030", "zigbee")  # 打开数据库，配置数据库
...
while True:  # 无限循环读取数据
    ...
    #     continue
    # print("did: " + did)
    # sql = "INSERT INTO Monitor_Data(mine_data)VALUES('" + did + "')"
    print(sql)
